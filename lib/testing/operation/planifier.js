...
var planifier = /** @class */ (function () {
    ...
    planifier.prototype.submitForm = function (log) {
        var json = this.getInformationToJson(log);
        //this.saveJson(json);
        this.setdata(this._conn.connexionAPI(log.gettoken(), json, log.constructUrl(url_1.urlPlaniPost), 'POST'));
        //for test
     ...
     * @memberof planifier
     */
    planifier.prototype.getInformationToJson = function (log) {
        //get de properties
     ...
     * @memberof planifier
     */
    planifier.prototype.createGeoJson = function (proj, coord) {
        var geojson = {
            "type": "Polygon",
            "crs": {
                "type": "name",
