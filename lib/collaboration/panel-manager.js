            ...
            this.controls = {
                ...
                write: {
                    ...
                    action: function () {
                        ...
                        var graphics = that.drawToolbar.graphicsLayer.graphics;
                        var json = {
                        ...
                        for (var _i = 0, graphics_1 = graphics; _i < graphics_1.length; _i++) {
                            ...
                            var feature = {
                                ...
                                'geometry': {
                                    ...
                                    'crs': {
                                        'type': 'link',
                                        'properties': {
                                            'href': 'https://epsg.io/3978.prettywkt',
                                            'type': 'wkt'
                                        }
                                    }
                                }
                            ...
                            if (graphic.geometry.type === 'point') {
                                ...
                                feature.geometry.coordinates.push(graphic.geometry.x, graphic.geometry.y);
                            }
                        ...
                        FileSaver.saveAs(file, "viewer.json");
                    }
                }
            };
