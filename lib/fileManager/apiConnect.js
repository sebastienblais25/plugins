...
var Connexion = /** @class */ (function () {
    ...
    Connexion.prototype.connexionAPIFileManagerTestDownload = function (token, urltogo, operation, content) {
        /********* API CALL **********/
        return new Promise(function (resolve) {
            $.ajax({
                // URL of the API
    ...
    Connexion.prototype.connexionAPIFileManagerTestUpload = function (token, urltogo, operation, file) {
        /********* API CALL **********/
        return new Promise(function (resolve) {
            $.ajax({
                // URL of the API
