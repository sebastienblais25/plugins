...
var url_1 = require("../fileManager/url");
...
var FileMana = /** @class */ (function () {
    ...
    FileMana.prototype.obtainArbo = function (token) {
        this._nextFolder = '';
        this._value = this._conn.connexionAPIFileManager(token, this.setNavigation(url_1.urlListFile), 'Get', 'application/json');
    };
    /**
     ...
     * @memberof FileMana
     */
    FileMana.prototype.setNavigation = function (urlgoto) {
    ...
    FileMana.prototype.uploadfile = function (path, token, file) {
        alert(path + ' ' + token);
        console.log(file);
        this._conn.connexionAPIFileManager(token, this.setNavigation(url_1.urlFileAction), 'POST', 'application/json', file);
    };
    /**
    ...
    FileMana.prototype.downloadFile = function (nameFile, path, token) {
        /***** API Call *****/
        var dlFile = this._conn.connexionAPIFileManager(token, this.setNavigation(url_1.urlFileAction), 'Get', 'application/octet-stream');
        /***** Download *****/
        console.log(dlFile);
    ...
    FileMana.prototype.deleteFile = function (nameFile, path, token) {
        /***** API Call *****/
        var dlFile = this._conn.connexionAPIFileManager(token, this.setNavigation(url_1.urlFileAction), 'Delete', 'application/json');
        console.log(dlFile);
