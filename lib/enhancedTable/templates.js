...
`;
exports.CLEAR_FILTERS_TEMPLATE = `
...
`;
exports.COLUMN_VISIBILITY_MENU_TEMPLATE = `
...
exports.MOBILE_MENU_BTN_TEMPLATE = `
...
exports.DETAILS_TEMPLATE = (oid) => `<button ng-controller='DetailsAndZoomCtrl as ctrl' ng-click='ctrl.openDetails(${oid})' md-ink-ripple class='md-icon-button rv-icon-16 md-button ng-scope enhanced-table-details' aria-label="{{ 'plugins.enhancedTable.detailsAndZoom.details' | translate }}">
...
exports.ZOOM_TEMPLATE = (oid) => `<button ng-controller='DetailsAndZoomCtrl as ctrl' ng-click='ctrl.zoomToFeature(${oid})'  md-ink-ripple class='md-icon-button rv-icon-16 md-button ng-scope enhanced-table-zoom' aria-label="{{ 'plugins.enhancedTable.detailsAndZoom.zoom' | translate }}">
...
exports.NUMBER_FILTER_TEMPLATE = (value, isStatic) => {
...
exports.DATE_FILTER_TEMPLATE = (value, isStatic) => {
    if (isStatic === true) {
        return `<span>
...
exports.TEXT_FILTER_TEMPLATE = (value, isStatic) => {
...
exports.CUSTOM_HEADER_TEMPLATE = (displayName) => `
...
`;
exports.SELECTOR_FILTER_TEMPLATE = (value, isStatic) => {
    if (isStatic === true) {
...
exports.PRINT_TABLE = (title, cols, rws) => {
...
exports.TABLE_UPDATE_TEMPLATE = `<md-toast class="table-toast">
...
exports.TABLE_LOADING_TEMPLATE = (legendEntry) => 
// hhite match parent
