        ...
        mapApi.agControllerRegister('submitFromP', function () {
            ...
            this.submitFormP = function () {
                ...
                if (document.getElementById("idUt").value === '') {
                    ...
                    var plan = new planifier_1.planifier(_this.selectedItemC, document.getElementById("idUt").value, _this.selectedItemD, listofclass, _this.dfp, _this.wherep, log.getGeom());
