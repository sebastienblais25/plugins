...
var FileMana = /** @class */ (function () {
    ...
    FileMana.prototype.uploadfile = function (path, log, file) {
        ...
        console.log(file);
        this._conn.connexionAPIFileManager(log.getToken(), log.constructUrl(url_1.urlFileAction, path), 'POST', 'application/json', file);
    };
    /**
    ...
    FileMana.prototype.downloadFile = function (nameFile, path, log) {
        /***** API Call *****/
        var dlFile = this._conn.connexionAPIFileManager(log.getToken(), log.constructUrl(url_1.urlFileAction, this._breadcrumbs + '/' + nameFile), 'Get', 'application/octet-stream');
        /***** Download *****/
        console.log(dlFile);
    ...
    FileMana.prototype.deleteFile = function (nameFile, path, log) {
        /***** API Call *****/
        var dlFile = this._conn.connexionAPIFileManager(log.getToken(), log.constructUrl(url_1.urlFileAction, this._breadcrumbs + '/' + nameFile), 'Delete', 'application/json');
        console.log(dlFile);
