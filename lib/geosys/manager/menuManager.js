...
var unitTravail_1 = require("../templates/unitTravail");
var unitTravC_1 = require("../controller/unitTravC");
var menuManager = /** @class */ (function () {
    ...
    function menuManager(log, panel, mapApi, config) {
        ...
        this._workUnit = new unitTravC_1.UnitTravC();
    ...
    menuManager.prototype.UTManager = function (log, mapApi) {
        ...
        var output = unitTravail_1.uniteTravail;
        return output;
    };
    return menuManager;
}());
