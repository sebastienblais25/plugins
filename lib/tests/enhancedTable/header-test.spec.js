...
describe('the enhancedTable headers', function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        browser = remote;
                        return [4 /*yield*/, remote.get('http://localhost:6001/enhancedTable/samples/et-test.html')];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, Page.open(browser)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    it('should have a first column with a disabled move left button', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Page.firstColumnLeftButton(browser)];
                    case 1:
                        btn = _b.sent();
                        _a = expect;
                        return [4 /*yield*/, btn.isEnabled()];
                    case 2:
    ...
    it('should have a last column with a disabled move right button', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Page.lastColumnRightButton(browser)];
                    case 1:
                        btn = _b.sent();
                        _a = expect;
                        return [4 /*yield*/, btn.isEnabled()];
