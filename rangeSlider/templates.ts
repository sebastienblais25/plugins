...
<div class="slider-bar-control slider-lock-control">
    <md-button
        ...
        ng-click="ctrl.lock()">
        <md-tooltip>{{ !ctrl.value.isLocked ? 'plugins.rangeSlider.bar.lock' : 'plugins.rangeSlider.bar.unlock' | translate }}</md-tooltip>
...
<div class="slider-bar-control slider-loop-control">
    <md-button
        ...
        class="md-icon-button primary"
        ng-click="ctrl.loop()">
        <md-tooltip>{{ !ctrl.value.isLooped ? 'plugins.rangeSlider.bar.loop' : 'plugins.rangeSlider.bar.unloop' | translate }}</md-tooltip>
...
<div class="slider-bar-control slider-play-control">
    ...
    <md-button
        ...
        aria-label="{{ ctrl.value.isPlaying ? 'plugins.rangeSlider.bar.pause' : 'plugins.rangeSlider.bar.play' | translate }}"
        class="md-icon-button primary"
        ng-click="ctrl.play()">
        <md-tooltip>{{ ctrl.value.isPlaying ? 'plugins.rangeSlider.bar.pause' : 'plugins.rangeSlider.bar.play' | translate }}</md-tooltip>
